...
class Employee:
    ...
    @property
    def email(self):
        return '{}.{}.@goey.co'.format(self.first_name.lower(), self.last_name.lower())
...
# import datetime
#
# my_date = datetime.date(2019, 3, 15)
...
# developer_2 = Developer('Mian', 'Savvy', 7000, 'PHP')
# developer_3 = Developer('Amir', 'Khan', 9000, 'C#')
